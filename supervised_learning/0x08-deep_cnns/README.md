...
-   [An Overview of ResNet and its Variants](https://intranet.hbtn.io/rltoken/5K6-Mx3hLdnrPG5yPfVSeg "An Overview of ResNet and its Variants")
-   [Review: ResNet --- Winner of ILSVRC 2015 (Image Classification, Localization, Detection)](https://intranet.hbtn.io/rltoken/dBX6xyuWBPpsrhkqRZ7nRg "Review: ResNet --- Winner of ILSVRC 2015 (Image Classification, Localization, Detection)")
...
-   [Review: ResNeXt --- 1st Runner Up in ILSVRC 2016 (Image Classification)](https://intranet.hbtn.io/rltoken/MbVC8TQkg5KloJcDFkHvog "Review: ResNeXt --- 1st Runner Up in ILSVRC 2016 (Image Classification)")
-   [Review: DenseNet --- Dense Convolutional Network (Image Classification)](https://intranet.hbtn.io/rltoken/_rC3jruM4fE_1dIyTHF1fw "Review: DenseNet --- Dense Convolutional Network (Image Classification)")
...
-   [Network In Network](https://intranet.hbtn.io/rltoken/Ojhi5RRK-gRiBUb8TarnhQ "Network In Network") (*Note: I suggest watching this video at 1.5x - 2x speed*)
-   [Inception Network Motivation](https://intranet.hbtn.io/rltoken/mPZn8RaZSd-mrtLFpgQxeA "Inception Network Motivation") (*Note: I suggest watching this video at 1.5x - 2x speed*)
-   [Inception Network](https://intranet.hbtn.io/rltoken/kW9ikSvwlX4SnKd2ByHsUQ "Inception Network") (*Note: I suggest watching this video at 1.5x - 2x speed*)
-   [Resnets](https://intranet.hbtn.io/rltoken/A7I7yn7TKmjxrzFbTYzpWA "Resnets") (*Note: I suggest watching this video at 1.5x - 2x speed*)
-   [Why ResNets Work](https://intranet.hbtn.io/rltoken/dpEseLBJZ972kxgT9TjwgQ "Why ResNets Work") (*Note: I suggest watching this video at 1.5x - 2x speed*)
...
At the end of this project, you are expected to be able to [explain to anyone](https://intranet.hbtn.io/rltoken/dVCJlCkerLRmFm2iiw3KwA "explain to anyone"), **without the help of Google**:
