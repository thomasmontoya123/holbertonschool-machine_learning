...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        saver = tf.train.import_meta_graph(
            '/Users/thomas/PycharmProjects/holbertonschool-machine_learning/supervised_learning/0x03-optimization/graph.ckpt.meta')
        saver.restore(sess,
                      '/Users/thomas/PycharmProjects/holbertonschool-machine_learning/supervised_learning/0x03-optimization/graph.ckpt')
